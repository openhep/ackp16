...
label_line -- Line labeling from http://stackoverflow.com/questions/19876882/print-string-over-plotted-line-mimic-contour-plot-labels
...
def label_line(line, label_text, near_i=None, near_x=None, near_y=None, rotation_offset=0, offset=(0,0)):
    ...
    def put_label(i):
        ...
        plt.text(pos[0], pos[1], label_text, size=9, rotation=rotation, 
